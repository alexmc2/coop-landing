          ...
          <div className="py-12 md:py-20">
            ...
            <div className="mx-auto max-w-3xl">
              <article>
                ...
                {/* Article image */}
                {post.metadata.image && (
                  <figure className="relative my-8 overflow-hidden rounded-2xl border border-slate-800/80 before:absolute before:inset-0 before:-z-10 before:bg-linear-to-br before:from-slate-900 before:via-indigo-500/50 before:to-indigo-500 before:opacity-50 lg:-ml-32 lg:-mr-32">
                    <Image
                      className="aspect-video w-full object-cover opacity-70 slatescale"
