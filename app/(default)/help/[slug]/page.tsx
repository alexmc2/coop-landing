        ...
        <div className="py-12 md:py-20">
          <div className="flex flex-col justify-between md:flex-row">
            ...
            <section className="order-1 md:flex-auto lg:pl-10">
              <article className="prose max-w-none text-[15px] leading-normal text-indigo-200/90 prose-headings: prose-headings:font-semibold prose-headings:text-slate-200 prose-h2:mb-2 prose-h2:mt-0 prose-h2:text-lg prose-a:font-medium prose-a:text-indigo-500 prose-a:no-underline hover:prose-a:underline prose-blockquote:border-l-2 prose-blockquote:pl-4 prose-blockquote:italic prose-strong:font-medium prose-strong:text-slate-200 prose-ul:list-none prose-ul:space-y-8 prose-ul:pl-0 prose-li:m-0 prose-li:pl-0">
                <div className="mb-8">
