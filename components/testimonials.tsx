          ...
          <div className="flex justify-center pb-12 max-md:hidden md:pb-16">
            <div className="relative inline-flex flex-wrap justify-center rounded-[1.25rem] bg-slate-800/40 p-1">
              ...
              >
                <svg
                  className={`fill-current ${
                    category === 1 ? 'text-indigo-500' : 'text-slate-600'
                  }`}
              ...
              >
                <svg
                  className={`fill-current ${
                    category === 2 ? 'text-indigo-500' : 'text-slate-600'
                  }`}
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height={16}
              ...
              >
                <svg
                  className={`fill-current ${
                    category === 3 ? 'text-indigo-500' : 'text-slate-600'
                  }`}
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height={16}
              ...
              >
                <svg
                  className={`fill-current ${
                    category === 4 ? 'text-indigo-500' : 'text-slate-600'
                  }`}
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height={16}
              ...
              >
                <svg
                  className={`fill-current ${
                    category === 5 ? 'text-indigo-500' : 'text-slate-600'
                  }`}
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height={16}
...
export function Testimonial({
  ...
  return (
    <article
      className={`relative rounded-2xl bg-linear-to-br from-slate-900/50 via-slate-800/25 to-slate-900/50 p-5 backdrop-blur-xs transition-opacity before:pointer-events-none before:absolute before:inset-0 before:rounded-[inherit] before:border before:border-transparent before:[background:linear-gradient(to_right,var(--color-slate-800),var(--color-slate-700),var(--color-slate-800))_border-box] before:[mask-composite:exclude_!important] before:[mask:linear-gradient(white_0_0)_padding-box,_linear-gradient(white_0_0)] ${
