...
export default function PricingHome() {
  ...
  // Use slate (sky-like) shape in light mode, purple shape in dark mode
  const blurredShapeImage = mounted && theme === 'light' ? BlurredShapeSlate : BlurredShape;
  
  return (
    <section className="relative">
      <div
        className="pointer-events-none absolute bottom-0 left-1/2 -z-10 -mb-20 -translate-x-1/3 dark:block hidden"
        aria-hidden="true"
      >
        <Image
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,--theme(--color-slate-400/.25),transparent)1] md:py-20">
          ...
          <div className="mx-auto max-w-2xl">
            <div className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-slate-100/50 dark:bg-slate-900/50 p-8 text-center">
              ...
              <ul className="text-left text-slate-600 dark:text-slate-400 space-y-3 mb-8 max-w-md mx-auto">
                <li className="flex items-start">
                  <span className="text-sky-500 dark:text-indigo-400 mr-2">✓</span>
